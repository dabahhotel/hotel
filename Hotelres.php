...
<link rel="shortcut icon" href="dabah.jpg">

<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
<meta name="HandheldFriendly" content="true" />
<title>RESERVATION</title>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.6605" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.6605" />
<style type="text/css">
    .form-label-left{
        width:150px;
    }
...
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.6605" type="text/javascript"></script>
<script type="text/javascript">
 ...
 JotForm.displayLocalTime("hour_22", "min_22", "ampm_22");
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,{"name":"submitForm","qid":"2","text":"Submit","type":"control_button"},null,null,null,{"name":"roomType","qid":"6","text":"Room Type","type":"control_dropdown"},null,null,null,{"name":"freePickup","qid":"10","text":"Free Pickup?","type":"control_radio"},null,null,null,{"name":"clickTo14","qid":"14","text":"DABAH  HOTEL RESERVATION ","type":"control_head"},null,{"name":"name","qid":"16","text":"Name","type":"control_fullname"},{"name":"email17","qid":"17","text":"E-mail","type":"control_email"},{"name":"numberOf18","qid":"18","text":"Number of Guests","type":"control_spinner"},null,{"name":"departureDate20","qid":"20","text":"Departure Date","type":"control_birthdate"},null,{"name":"arrivalDate","qid":"22","text":"Arrival Date & Time","type":"control_datetime"},null,null,null,null,null,null,null,{"name":"specialRequests","qid":"30","text":"Special Requests","type":"control_textarea"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,{"name":"submitForm","qid":"2","text":"Submit","type":"control_button"},null,null,null,{"name":"roomType","qid":"6","text":"Room Type","type":"control_dropdown"},null,null,null,{"name":"freePickup","qid":"10","text":"Free Pickup?","type":"control_radio"},null,null,null,{"name":"clickTo14","qid":"14","text":"DABAH  HOTEL RESERVATION ","type":"control_head"},null,{"name":"name","qid":"16","text":"Name","type":"control_fullname"},{"name":"email17","qid":"17","text":"E-mail","type":"control_email"},{"name":"numberOf18","qid":"18","text":"Number of Guests","type":"control_spinner"},null,{"name":"departureDate20","qid":"20","text":"Departure Date","type":"control_birthdate"},null,{"name":"arrivalDate","qid":"22","text":"Arrival Date & Time","type":"control_datetime"},null,null,null,null,null,null,null,{"name":"specialRequests","qid":"30","text":"Special Requests","type":"control_textarea"}]);}, 20); 
</script>
</head>
<body>
<form class="jotform-form" action="https://submit.myjotform.com/submit/81763492228564/" method="post" name="form_81763492228564" id="81763492228564" accept-charset="utf-8">
  <input type="hidden" name="formID" value="81763492228564" />
  <div class="form-all">
    <ul class="form-section page-section">
        ...
        <div style="display:table;width:100%">
          <div class="form-header-group hasImage">
            ...
            <div class="header-logo">
              <img src="dabah.jpg" alt="" width="223" class="header-logo-right" />
            </div>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_fullname" id="id_16">
        <label class="form-label form-label-top" id="label_16" for="first_16">
          Name
        ...
        <div id="cid_16" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="text" id="first_16" name="q16_name[first]" class="form-textbox validate[required]" size="10" value="" data-component="first" required="" />
              <label class="form-sub-label" for="first_16" id="sublabel_first" style="min-height:13px"> First Name </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="text" id="last_16" name="q16_name[last]" class="form-textbox validate[required]" size="15" value="" data-component="last" required="" />
              <label class="form-sub-label" for="last_16" id="sublabel_last" style="min-height:13px"> Last Name </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_email" id="id_17">
        ...
        <div id="cid_17" class="form-input-wide jf-required">
          <input type="email" id="input_17" name="q17_email17" class="form-textbox validate[required, Email]" size="32" value="" placeholder="ex: myname@example.com" data-component="email" required="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_dropdown" id="id_6">
        ...
        <div id="cid_6" class="form-input-wide jf-required">
          <select class="form-dropdown validate[required]" id="input_6" name="q6_roomType" style="width:198px" data-component="dropdown" required="">
            <option value="">  </option>
      ...
      <li class="form-line jf-required" data-type="control_spinner" id="id_18">
        ...
        <div id="cid_18" class="form-input-wide jf-required">
          <input type="number" id="input_18" name="q18_numberOf18" data-type="input-spinner" class="form-spinner-input  form-textbox validate[required]" value="0" data-component="spinner" required="" />
        </div>
      </li>
      <li class="form-line jf-required allowTime" data-type="control_datetime" id="id_22">
        ...
        <div id="cid_22" class="form-input jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="tel" class="form-textbox validate[required, limitDate]" id="month_22" name="q22_arrivalDate[month]" size="2" data-maxlength="2" value="06" required="" />
            ...
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="tel" class="currentDate form-textbox validate[required, limitDate]" id="day_22" name="q22_arrivalDate[day]" size="2" data-maxlength="2" value="26" required="" />
              <span class="date-separate">
                 -
              </span>
            ...
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="tel" class="form-textbox validate[required, limitDate]" id="year_22" name="q22_arrivalDate[year]" size="4" data-maxlength="4" value="2018" required="" />
            ...
            <span style="white-space:nowrap;display:inline-block" class="allowTime-container">
              <span class="form-sub-label-container" style="vertical-align:top">
                ...
                <label class="form-sub-label" for="at_22" style="min-height:13px">  </label>
              </span>
              <span class="form-sub-label-container" style="vertical-align:top">
                <select class="currentTime time-dropdown form-dropdown validate[required, limitDate]" id="hour_22" name="q22_arrivalDate[hour]">
                  <option>  </option>
                ...
                <label class="form-sub-label" for="hour_22" id="sublabel_hour" style="min-height:13px"> Hour </label>
              </span>
              <span class="form-sub-label-container" style="vertical-align:top">
                <select class="time-dropdown form-dropdown validate[required, limitDate]" id="min_22" name="q22_arrivalDate[min]">
                  <option>  </option>
                ...
                <label class="form-sub-label" for="min_22" id="sublabel_minutes" style="min-height:13px"> Minutes </label>
              </span>
              <span class="form-sub-label-container" style="vertical-align:top">
                <select class="time-dropdown form-dropdown validate[required, limitDate]" id="ampm_22" name="q22_arrivalDate[ampm]">
                  <option selected="" value="AM"> AM </option>
                  <option value="PM"> PM </option>
                </select>
                <label class="form-sub-label" for="ampm_22" style="min-height:13px">  </label>
              </span>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top">
              <img class="showAutoCalendar" alt="Pick a Date" id="input_22_pick" src="https://cdn.jotfor.ms/images/calendar.png" style="vertical-align:middle" data-component="datetime" />
              <label class="form-sub-label" for="input_22_pick" style="min-height:13px">  </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_birthdate" id="id_20">
        ...
        <div id="cid_20" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top">
              <select name="q20_departureDate20[month]" id="input_20_month" class="form-dropdown validate[required]" data-component="birthdate-month">
                <option>  </option>
              ...
              <label class="form-sub-label" for="input_20_month" id="sublabel_month" style="min-height:13px"> Month </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top">
              <select name="q20_departureDate20[day]" id="input_20_day" class="form-dropdown validate[required]" data-component="birthdate-day">
                <option>  </option>
                <option value="1"> 1 </option>
                <option value="2"> 2 </option>
                <option value="3"> 3 </option>
              ...
              <label class="form-sub-label" for="input_20_day" id="sublabel_day" style="min-height:13px"> Day </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top">
              <select name="q20_departureDate20[year]" id="input_20_year" class="form-dropdown validate[required]" data-component="birthdate-year">
                <option>  </option>
              ...
              <label class="form-sub-label" for="input_20_year" id="sublabel_year" style="min-height:13px"> Year </label>
            </span>
          </div>
        </div>
      </li>
        ...
        <div id="cid_10" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_10_0" name="q10_freePickup" value="Yes Please! - Pick me up on arrival" required="" />
              <label id="label_input_10_0" for="input_10_0"> Yes Please! - Pick me up on arrival </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_10_1" name="q10_freePickup" value="No Thanks - I&#x27;ll make my own way there" required="" />
              <label id="label_input_10_1" for="input_10_1"> No Thanks - I'll make my own way there </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_textarea" id="id_30">
        <label class="form-label form-label-top form-label-auto" id="label_30" for="input_30"> Special Requests </label>
        <div id="cid_30" class="form-input-wide">
          <textarea id="input_30" class="form-textarea" name="q30_specialRequests" cols="40" rows="10" data-component="textarea"></textarea>
        </div>
      </li>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="81763492228564" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "81763492228564-81763492228564";
  </script>
